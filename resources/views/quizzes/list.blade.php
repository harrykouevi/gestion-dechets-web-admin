...
@section('content') 
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800 mb-0">📋 Liste des Quiz</h1>
    ...
    @livewire('list-of-quizzes') <!-- Include the Livewire component -->
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.open-delete-modal').forEach(button => {
            button.addEventListener('click', function () {
                ...
                component.set('quizIdToDelete', id).then(() => {
    ...
    window.addEventListener('post-deleted', function () {
        ...
        // let component = Livewire.find(document.querySelector('[wire\\:id]').getAttribute('wire:id'));
        // if (!component) return;
        // component.set('quizIdToDelete', null).then(() => {
